...
@Component({
  selector: "zipper-like",
  templateUrl: "./zipper-like.component.html",
  styleUrls: ["./zipper-like.component.css"]
})
export class ZipperLikeComponent {
  title = "Zipper and Like demo";
  messages = [
    {
